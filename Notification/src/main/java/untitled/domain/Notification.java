...
public class Notification {
    ...
    public static void getNotificationByChangeStatus(
        ...
        */
        ...
        repository().findById(subscriptionCanceled.get???()).ifPresent(notification->{
    ...
    //<<< Clean Arch / Port Method
    public static void getNotificationByChangeStatus(
        SubscriptionApplicationCompleted subscriptionApplicationCompleted
    ) {
        //implement business logic here:
        ...
        */
        ...
        repository().findById(subscriptionApplicationCompleted.get???()).ifPresent(notification->{
    ...
    //<<< Clean Arch / Port Method
    public static void getNotificationByChangeStatus(
        InsuranceReviewApproved insuranceReviewApproved
    ) {
        //implement business logic here:
        ...
        */
        ...
        repository().findById(insuranceReviewApproved.get???()).ifPresent(notification->{
    ...
    //<<< Clean Arch / Port Method
    public static void getNotificationByChangeStatus(
        InsuranceReviewCanceled insuranceReviewCanceled
    ) {
        //implement business logic here:
        ...
        */
        ...
        repository().findById(insuranceReviewCanceled.get???()).ifPresent(notification->{
